...
parser.add_argument("factor", type=int,help="factor for STFT: n_fft=4096//factor")
...
start = time()
train_set = MusicNet_Spec(path='./data/', groups=['train'], sequence_length=327680, save_name=f'librosa-STFT-{n_fft}', refresh=True)
...
import pickle
with open(f'./result/librosa_result_STFT-{n_fft}', 'wb') as f:
