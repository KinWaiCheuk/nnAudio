...
start = time()
train_set = MusicNet_Spec(path='./data/', groups=['train'], sequence_length=327680, save_name=f'librosa-CQT-{resolution}', refresh=True)
...
import pickle
with open(f'./result/librosa_result_CQT-{args.resolution}', 'wb') as f:
