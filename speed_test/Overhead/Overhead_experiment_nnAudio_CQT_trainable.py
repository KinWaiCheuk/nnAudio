...
class Model(torch.nn.Module):
    def __init__(self):
        ...
        self.STFT_layer = Spectrogram.CQT1992v2(sr=44100, fmin=27.5, n_bins=n_bins, bins_per_octave=bins_per_octave, pad_mode='constant', hop_length=HOP_LENGTH, trainable=True, center=True, device=device)
...
import pickle
with open(f'./result/trainable_nnAudio_result_CQT-{n_bins}', 'wb') as f:
    pickle.dump(nnAudio_result,f)
    
torch.save(model.state_dict(), f'./weight/trainable_nnAudio_result_CQT-{args.resolution}')
