...
class STFT(torch.nn.Module):
    ...
    def __init__(self, n_fft=2048, freq_bins=None, hop_length=512, window='hann', 
                ...
                fmin=50, fmax=6000, sr=22050, trainable=False, output_format='Magnitude', 
        ...
        wsin, wcos, self.bins2freq, self.bin_list = create_fourier_kernels(n_fft=n_fft, 
                                                                           freq_bins=freq_bins, 
                                                                           window=window, 
    ...
    def forward(self,x):
        ...
        if self.output_format=='Magnitude':
            ...
            # +0.0 helps remove -0.0 elements, which leads to error in calcuating phase
